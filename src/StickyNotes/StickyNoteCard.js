...
const StickyNoteCard = (props) => {
  ...
  return (
    <div className=" group w-60 h-56 bg-yellow-100  flex-col p-3 shadow-md rounded ring-1 ring-gray-200">
      ...
      <div className="mb-1 ">
        <input
          className="my-1 rounded-md border bg-yellow-100 border-yellow-100 focus:border-blue-600 focus:border-[2px]  focus:outline-none h-10 w-full p-2"
          value={notetitle}
      ...
      <div>
        <div>
          <textarea
            className="my-1 rounded-md border bg-yellow-100 border-yellow-100 focus:border-blue-600 focus:border-[2px]  focus:outline-none w-full h-[95px] p-2 resize-none"
